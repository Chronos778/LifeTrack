...
│   │   │   ├── EditDoctorModal.js
│   │   │   ├── EditRecordModal.js
│   │   │   ├── EditTreatmentModal.js
│   │   │   ├── VoiceRecordModal.js
│   │   │   ├── VoiceAddDoctorModal.js
│   │   │   └── ... (other components)
...
- Configurable in api.js service

## API Endpoints

### Health Records
- GET, POST, PUT, DELETE `/health_records`

### Doctors  
- GET, POST, PUT, DELETE `/doctors`

### Treatments
- GET, POST, PUT, DELETE `/treatment`
...
### Partially Supported
- Firefox (no voice features) ⚠️
- Opera (may have voice issues) ⚠️

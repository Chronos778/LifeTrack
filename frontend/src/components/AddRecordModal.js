    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h2 className="modal-title">Add New Health Record</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label className="form-label">
              Diagnosis <span style={{ color: '#ff006e' }}>*</span>
            </label>
            <input
              type="text"
              className="neo-input"
          ...
          <div className="form-group">
            <label className="form-label">
              Doctor <span style={{ color: '#ff006e' }}>*</span>
            </label>
            <select
              className="neo-input"
              name="doctor_id"
          ...
          <div className="form-group">
            <label className="form-label">
              Record Date <span style={{ color: '#ff006e' }}>*</span>
            </label>
            <input
              type="date"
              className="neo-input"

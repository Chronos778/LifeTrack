    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h2 className="modal-title">Add New Treatment</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label className="form-label">
              Health Record <span style={{ color: '#ff006e' }}>*</span>
            </label>
            <select
              className="neo-input"
              name="record_id"
          ...
          <div className="form-group">
            <label className="form-label">
              Medication <span style={{ color: '#ff006e' }}>*</span>
            </label>
            <input
              type="text"
              className="neo-input"
          ...
          <div className="form-group">
            <label className="form-label">Procedure/Instructions</label>
            <textarea
              className="neo-input"
              name="procedure"

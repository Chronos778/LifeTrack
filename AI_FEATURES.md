...
## Overview
All AI-related feature details are now documented directly in `README.md`.

Please refer to the **AI Features** and **Chatbot / Voice Features** sections
in `README.md` for the latest information.
...
### 2. **Summary Card**
``` 
📊 Overview [AI-generated health summary text]
```
...
### 6. **Footer Disclaimer**
``` 
💡 These insights are generated by AI and should not replace professional medical advice. Always consult with your healthcare provider for medical decisions.
```
